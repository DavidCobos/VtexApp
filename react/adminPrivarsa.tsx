...
const AdminOtherExample: FC = () => {
  ...
  const [mutateFunction, {data: resMut}] = useMutation(createFacturacion)

  const {data} = useQuery(getFacturation)
            ...
            <div className="w-100 mv6">
              <Dropzone
                ...
                onDropAccepted={(e: any) => {
                  ...
                  formData.append("archivo", e.File[0])
                  
                  setForm(formData)
                  setNombreArchivo(e.File[0].name)
